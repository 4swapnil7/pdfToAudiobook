...
"""
    ...
    image_address = Image.open("C:/Mini Project Sem4/project/audiobook2.png")
        ...
        try:
            ...
            if option == 1:
                ...
                for i in range(fromPageNo - 1, toPageNo):
                    ...
                    Text += pageObj.extractText()
                    print("Checking type of text",type(Text))
            ...
            name1 = name.split('.', 1)
            AudioBook = (name1[0])
            if os.path.exists('C:\Mini Project Sem4\project'):
            ...
            if (option == 0 and (fromPageNo == 0 or toPageNo == 0)):
                ...
                tk.messagebox.showwarning("show warning", "provide page numbers")
    ...
    def save():
        filename = filedialog.asksaveasfilename(initialdir='C:\Mini Project Sem4\project', title='save file',
...
'''
    ...
    c11 = tk.Checkbutton(Frame1, text="All Pages", bg="#b30059", selectcolor="black", fg="white", variable=option_value,
